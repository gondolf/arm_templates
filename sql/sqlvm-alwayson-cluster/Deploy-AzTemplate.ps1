...
# Example
# .\Deploy-AzTemplate.ps1 -ArtifactStagingDirectory . -Location eastus2 -TemplateFile azuredeploy.json -TemplateParametersFile azuredeploy.parameters.json
# .\Deploy-AzTemplate.ps1 -ArtifactStagingDirectory .\bin\Debug\staging\ExampleAppDeploy -Location eastus2 -TemplateFile azuredeploy.json -TemplateParametersFile azuredeploy.parameters.json -UploadArtifacts -StorageAccountName <storage-account-name>
